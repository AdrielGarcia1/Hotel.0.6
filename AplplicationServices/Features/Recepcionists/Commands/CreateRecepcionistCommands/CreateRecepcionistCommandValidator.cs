...
{
    // Validador para el comando de creación de un nuevo Receptionist
    public class CreateRecepcionistCommandValidator : AbstractValidator<CreateRecepcionistCommand>
    {
        ...
        {
            // Reglas de validación para cada propiedad del comando
            ...
            RuleFor(x => x.EmailRecep)
                ...
                .WithMessage("{PropertyName} debe ser una dirección de e-mail válida.")
